...
> = ResolversObject<{
  addRedditScrapeRequest?: Resolver<
    Maybe<ResolversTypes["ScrapeRequest"]>,
    ParentType,
    ContextType,
    RequireFields<MutationAddRedditScrapeRequestArgs, "subreddits">
  >;
}>;
...
export type ScrapeRequestResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["ScrapeRequest"] = ResolversParentTypes["ScrapeRequest"]
> = ResolversObject<{
  data?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  returnType?: Resolver<
    Maybe<ResolversTypes["ScrapeReturnType"]>,
    ParentType,
    ContextType
  >;
  status?: Resolver<
    Maybe<ResolversTypes["ScrapeStatus"]>,
    ParentType,
    ContextType
  >;
